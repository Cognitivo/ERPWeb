...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Cognitivo | User Login</title>
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="index.html">
                <img height="50px" src="{{url()}}/assets/global/img/CognitivoLogo.png" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
        ...
        <div class="copyright"> 2014 © Cognitivo. Admin Dashboard Template. </div>
        <!--[if lt IE 9]>
