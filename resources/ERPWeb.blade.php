...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{url()}}/assets/layouts/layout7/css/layout.min.css" rel="stylesheet" type="text/css" />
        <link href="{{url()}}/assets/layouts/layout7/css/custom.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class="page-container-bg-solid">
            ...
            <div class="clearfix">
                ...
                <div class="burger-trigger">
                    <button class="menu-trigger">
                        <img src="{{url()}}/assets/layouts/layout7/img/m_toggler.png" alt=""> </button>
                ...
                <div class="page-logo">
                    <a href="index.html">
                        <img src="{{url()}}/assets/layouts/layout7/img/logo.png" alt="logo" class="logo-default" /> </a>
                </div>
                <!-- END LOGO -->
                        ...
                        <li class="dropdown dropdown-user">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                <div class="dropdown-user-inner">
                                    ...
                                    <img alt="" src="{{url()}}/assets/layouts/layout7/img/avatar1.jpg" /> </div>
                            </a>
        ...
        <div class="page-footer">
            <div class="page-footer-inner container-fluid container-lf-space">
                <p class="page-footer-copyright"> 2016 &copy; Cognitivo
                    </p>
            </div>
            <div class="go2top">
...
<![endif]-->
        ...
        <script src="{{url()}}/assets/layouts/layout7/scripts/layout.min.js" type="text/javascript"></script>
