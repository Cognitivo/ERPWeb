...
class contactsubscriptionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $subscription->id_contract  = Contract::where('is_default', 1)->first()->id_contract;
        $subscription->id_vat_group = \DB::table('app_vat_group')->where('is_default', 1)->first()->id_vat_group;
        //dd($subscription);
        $subscription->save();
